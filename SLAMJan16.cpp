...
int main(int argc, char * argv[])
{
   ...
   // assert(pcl::console::parse_argument(argc, argv, "-l", logFile) > 0 && "Please provide a log file");
    ...
    ofstream fout1("fr1xyz_FOVISJan16Trial2.txt");
    ofstream fout2("fr1xyz_KeyframeMotionMetric0.3Jan16Trial2.txt");
    ofstream fout3("fr1xyz_closure_transformationJan16Trial2.txt");
    ofstream fout4("fr1xyz_pose_after_optimizationJan16Trial2.txt");
    ofstream fout5("fr1xyz_covarianceJan16Trial2.txt");
