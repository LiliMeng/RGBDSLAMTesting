...
int main(int argc, char * argv[])
{
    ...
    readRGBDdata("/home/lili/workspace/SLAM/evaluation/fr1_desk2/fr1desk2TimeAssoData.txt");
    ...
    /*else
    {
        ...
        if(frame_index != RGBDFileInfo.size())
        {
          ...
          //  cout<<"depth_frame.type "<<depth_frame.type()<<endl;
            ...
            DVOdometry * dvo = static_cast<DVOdometry *>(odom);
            dvo->firstRun(imageData,
                          depthData);
          }

    ofstream fout1("/home/lili/workspace/SLAM/evaluation/fr1_desk2/DVOTrial1/fr1_desk2VOMarch26.txt");
    ofstream fout2("/home/lili/workspace/SLAM/evaluation/fr1_desk2/DVOTrial1/fr1_desk2VOMarch26Keyframe.txt");
    ofstream fout3("/home/lili/workspace/SLAM/evaluation/fr1_desk2/DVOTrial1/fr1_desk2VOMarch26LoopClosureTrans.txt");
    ofstream fout4("/home/lili/workspace/SLAM/evaluation/fr1_desk2/DVOTrial1/fr1_desk2VOMarch26AfterOptimization.txt");
    ofstream fout5("/home/lili/workspace/SLAM/evaluation/fr1_desk2/DVOTrial1/fr1_desk2VOMarch26SLAM.txt");
