...
int main(int argc, char * argv[])
{
   ...
   cout<<"logReader OK"<<endl;
    ...
    ofstream fout1("camera_pose_FOVISDec25.csv");
    ofstream fout2("camera_pose_KeyframeMotionMetric0.1Dec25.csv");
    ofstream fout3("loop_closure_transformationDec25.csv");
    ofstream fout4("camera_pose_after_optimizationDec25.csv");
