...
int main(int argc, char * argv[])
{
    ...
    readRGBDdata("/home/lili/workspace/SLAM/src/fr1xyzAssociatedData.txt");
...
//        #1
       ...
       // printf("odom finish frame %d\n", frame_index);
        ...
        if(odom->getState())
        {
          ...
          fout1<<frame_index<<" "<<RGBDFileInfo[frame_index].real_timestamp<<" "<<tcurr[0]<<" "<<tcurr[1]<<" "<<tcurr[2]<<" "<<quatFrame.w()<<" "<<quatFrame.x()<<" "<<quatFrame.y()<<" "<<quatFrame.z()<<endl;
       ...
       // fout5<<covariance(0,0)<<" "<<<<covariance(0,1)<<" "<<covariance(0,2)<<" "<<covariance(0,3)<<" "<<covariance(0,4)<<" "<<covariance(0,5)<<" "<<covariance(1,0)<<" "<<covariance(1,1)<<" "<<covariance(1,2)<<" "<<covariance(1,3)<<" "<<covariance(1,4)<<" "<<covariance(1,5)<<" "<<covariance(2,0)<<" "<<covariance(2,1)<<" "<<covariance(2,2)<<" "<<covariance(2,3)<<" "<<covariance(2,4)<<" "<<covariance(2,5)<<" "<<covariance(3,0)<<" "<<covariance(3,1)<<" "<<covariance(3,2)<<" "<<covariance(3,3)<<" "<<covariance(3,4)<<" "<<covariance(3,5)<<" "<<covariance(4,0)<<" "<<covariance(4,1)<<" "<<covariance(4,2)<<" "<<covariance(4,3)<<" "<<covariance(4,4)<<" "<<covariance(4,5)<<" "<<covariance(5,0)<<" "<<covariance(5,1)<<" "<<covariance(5,2)<<" "<<covariance(5,3)<<" "<<covariance(5,4)<<" "<<covariance(5,5)<<" "<<covariance(6,0)<<" "<<covariance(6,1)<<" "<<covariance(6,2)<<" "<<covariance(6,3)<<" "<<covariance(6,4)<<" "<<covariance(6,5)<<endl;
...
//          #2
           ...
           fout2<<frame_index<<" "<<RGBDFileInfo[frame_index].real_timestamp<<" "<<tcurr[0]<<" "<<tcurr[1]<<" "<<tcurr[2]<<" "<<quatKeyframe.w()<<" "<<quatKeyframe.x()<<" "<<quatKeyframe.y()<<" "<<quatKeyframe.z()<<endl;
  ...
  //  cloudViewer.addPointCloud<pcl::PointXYZRGB>(cloud->makeShared(), color, "Cloud Viewer");
   ...
   cout<<"The number of optimized poses"<<poses.size()<<endl;
    ...
    for(std::vector<std::pair<uint64_t, Eigen::Matrix4f> >::iterator ite=poses.begin(); ite!=poses.end(); ite++)
    {
        ...
        fout4<<ite->second(0,3)<<" "<<ite->second(1,3)<<" "<<ite->second(2,3)<<endl;
       // fout41<<ite->second(0,3)<<" "<<ite->second(1,3)<<" "<<ite->second(2,3)<<endl;
        ...
        //fout41<<ite->second(0,0)<<" "<<ite->second(0,1)<<" "<<ite->second(0,2)<<" "<<ite->second(0,3)<<" "<<ite->second(1,0)<<" "<<ite->second(1,1)<<" "<<ite->second(1,2)<<" "<<ite->second(1,3)<<" "<<ite->second(2,0)<<" "<<ite->second(2,1)<<" "<<ite->second(2,2)<<" "<<ite->second(2,3)<<" "<<ite->second(3,0)<<" "<<ite->second(3,1)<<" "<<ite->second(3,2)<<" "<<ite->second(3,3)<<endl;
