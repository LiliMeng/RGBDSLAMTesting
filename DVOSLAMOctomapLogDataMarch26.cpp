...
int main(int argc, char * argv[])
{
   ...
   // {
    ...
    ofstream fout1("camera_pose_DVOMarch26.txt");
    ofstream fout2("camera_pose_KeyframeMotionMetric0.1March26.txt");
    ofstream fout3("loop_closure_transformationMarch26.txt");
    ofstream fout4("camera_pose_after_optimizationMarch26.txt");
