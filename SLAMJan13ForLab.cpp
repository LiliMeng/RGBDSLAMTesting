...
int main(int argc, char * argv[])
{
   ...
   cout<<"logReader OK"<<endl;
    ...
    ofstream fout1("lab_camera_pose_FOVISJan13Trial1.txt");
    ofstream fout2("lab_camera_pose_KeyframeMotionMetric0.1Jan13Trial1.txt");
    ofstream fout3("lab_loop_closure_transformationJan13Trial1.txt");
    ofstream fout4("lab_camera_pose_after_optimizationJan13Trial1.txt");
...
//        #1
      ...
      // if(odom->getState())
       ...
       cout<<"frame to frame timestamp "<<logReader.timestamp<<endl;
...
//            #2
           ...
           cout<<"the keyframe timestamp"<<logReader.timestamp<<endl;
           /*
            //Save keyframe
           {
